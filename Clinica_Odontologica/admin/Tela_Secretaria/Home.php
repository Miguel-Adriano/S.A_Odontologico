...
<body>
  ...
  <div class="item">
    ...
    <!-- <table border="3" width="30%" cellpadding="7">
        <tr>
            <td width="16%" rowspan="4"bgcolor="yellow"></td>
                   
            <td width="16%" >L1 C2</td>
            <td width="16%" >L1 C3</td>
            <td width="17%" >L1 C4</td>
            <td width="17%" >L1 C5</td>
            <td width="17%" >L1 C6</td>
